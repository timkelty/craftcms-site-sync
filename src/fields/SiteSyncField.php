...
class SiteSyncField extends Field
{
    ...
    {
        return Craft::t('site-sync', 'SiteSyncField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'site-sync/_components/fields/SiteSyncField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(SiteSyncFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SiteSyncSiteSyncField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'site-sync/_components/fields/SiteSyncField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
